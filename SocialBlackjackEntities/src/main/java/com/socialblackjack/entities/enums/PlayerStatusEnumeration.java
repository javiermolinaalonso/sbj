package com.socialblackjack.entities.enums;
...
public enum PlayerStatusEnumeration {
	...
	SITOUT, //The player is sitting out, it is sit at the table but he wont receive cards
	...
	public boolean isOccupingSeat(){
		return 
				...
				this.equals(PlayerStatusEnumeration.SITOUT);
	}
}
